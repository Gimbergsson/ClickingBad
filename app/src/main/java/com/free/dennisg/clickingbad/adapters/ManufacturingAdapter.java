...
public class ManufacturingAdapter extends RecyclerView.Adapter<ManufacturingAdapter.ViewHolder> {
    ...
    public ManufacturingAdapter(Context context, List<Manufacturing> manufacturingList) {
    ...
    @Override
    public ManufacturingAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.manufacturing_card, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ManufacturingAdapter.ViewHolder viewHolder, int position) {
        Manufacturing manufacturing = manufacturingList.get(position);
        viewHolder.itemId.setText(String.valueOf(manufacturing.getItemId()));
    }
